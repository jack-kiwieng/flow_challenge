...
describe("Test convert method", () => {
      test("null input throws error", () => {
          expect(() => EpochTimeToFlowDataPointConverter.convert(null)).toThrow("No data provided.")
      });
      ...
      test("single data point returns expected result", () => {
          ...
          expect(EpochTimeToFlowDataPointConverter.convert(dataPoints)).toEqual(expectedResponseDataPoints);
       });
